...
public class MainSwing extends javax.swing.JFrame {
    ...
    public MainSwing(Canvas canvas, Main app) {
        this();
        this.app = app;
    ...
    private void initComponents() {
        ...
        jSlider1.addChangeListener(new javax.swing.event.ChangeListener() {
            public void stateChanged(javax.swing.event.ChangeEvent evt) {
                MainSwing.this.stateChanged(evt);
            }
        });
        ...
        jComboBox1.setSelectedIndex(999);
        ...
        layout.setVerticalGroup(
            ...
            .add(org.jdesktop.layout.GroupLayout.TRAILING, layout.createSequentialGroup()
                .addContainerGap()
                .add(jPanel1, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 588, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if (!app.isRunning()) { //PAUSED, so play it
            app.setRunning(true);
    ...
    private void stateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_stateChanged
        ...
        if (!source.getValueIsAdjusting()) {
            int velocity = (int) source.getValue();
            app.setVelocity(100 * velocity);
        }
    }//GEN-LAST:event_stateChanged

    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        JComboBox source = (JComboBox) evt.getSource();
        app.setBodies(Integer.parseInt((String) source.getSelectedItem()));
